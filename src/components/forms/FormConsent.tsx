  ...
  return (
    <div className="formConsent">
      <label className="checkField" htmlFor={consentId}>
        ...
        <span>
          I agree to Civitas Holdings processing these details to respond to my enquiry, as described in the{" "}
          <Link href="/privacy">Privacy Policy</Link>.
        </span>
      </label>
      <label className="checkField" htmlFor={updatesId}>
        <input id={updatesId} name="marketingOptIn" type="checkbox" />
        <span>Keep me informed about pilot launches and rollout updates. Optional.</span>
      </label>
