        ...
        <div className="innerHeroCard">
          ...
          <div className="pageHeroGrid">
            ...
            <div className="pageHeroVisual" aria-hidden="true">
              ...
              <span className="visualCore">CC</span>
              <span className="visualLabel visualLabelOne">Mobility</span>
              <span className="visualLabel visualLabelTwo">Delivery</span>
              <span className="visualLabel visualLabelThree">Energy</span>
            </div>
          </div>
