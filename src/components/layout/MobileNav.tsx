        ...
        <>
          ...
          >
            <div className="mobileNavIntro">
              <span>Civitas Cargo</span>
              <p>Smart electric cargo mobility for African last-mile logistics.</p>
            </div>
            ...
            <div className="mobileNavCtas">
              ...
              <Link href="/investors" className="btn" onClick={close}>
                Investor Relations
              </Link>
              <Link href="/contact" className="btn ghost" onClick={close}>
                Contact the team
              </Link>
            </div>
          </div>
